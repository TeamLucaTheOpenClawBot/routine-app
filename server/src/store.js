...
//
// 필요 Node: **22.13+**. node:sqlite는 22.5에 추가됐지만 22.13까지는 `--experimental-sqlite`
// 플래그 뒤에 있어서, 22.5~22.12에서는 플래그 없이 import하면 기동 중에 실패한다.
// `server/package.json`의 engines가 이 하한을 선언한다(배포 이미지는 node:24-alpine).
//
