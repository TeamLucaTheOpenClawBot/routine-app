...
- Phase 3: **#7 진행 중** 백엔드·계정·클라우드 동기화(1/4 스캐폴드 PR #27 · 2/4 저장소 PR #28 ·
  3/4 클라이언트 동기화 엔진 PR #30 머지 · **4/4 활성화·마이그레이션·상태 UI PR #32**(설정에서 켜기,
  owner를 바인딩해 엔진 활성화) — 이걸로 #7 완료 예정) · #6 알림
